...
public class DoneFragment extends Fragment {
    ...
    public static RecyclerView doneRecycle;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        doneRecycle = (RecyclerView) view.findViewById(R.id.recycler_view);

        TaskAdapter mAdapter = new TaskAdapter(getActivity(), MainActivity.doneTaskList, doneRecycle);
        RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(getActivity().getApplicationContext());
        doneRecycle.setLayoutManager(mLayoutManager);
        doneRecycle.setItemAnimator(new DefaultItemAnimator());
        doneRecycle.setAdapter(mAdapter);
